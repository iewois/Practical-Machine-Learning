...
```{r partioning training set, echo=TRUE,}
...
```{r cleaning subset data, echo=TRUE,}
...
Do the exact same 3 transformations for myTesting and testing data sets.
```{r repeat, echo=TRUE,}
...
```{r ML for random forests, echo=TRUE,}
